...
//                                 {voyages.map((voyage) => (
//                                     <option key={voyage.idVoyage} value={voyage.idVoyage}>
//                                         {voyage.lieudepart} --> {voyage.lieuarrivee}
//                                     </option>
//                                 ))}
//                             </select>
//                         </div>
...
//     });
//
//     const { depart, arrivee, prix } = ticket;
//
//     const onInputChange = (e) => {
//         setTicket({ ...ticket, [e.target.name]: e.target.value });
//     };
...
//         e.preventDefault();
//
//         // Check if "arrivee" is greater than "depart"
//         if (new Date(arrivee) <= new Date(depart)) {
//             toast.error("Arrival time must be greater than departure time.");
//             return;
//         }
...
//             <div className="row">
//                 <div className="col-md-6 offset-md-3 border rounded p-4 mt-2">
//                     <h2 className="text-center m-4">Add new ticket</h2>
//                     <form onSubmit={(e) => onSubmit(e)}>
//                         <div className="mb-3">
//                             <label htmlFor="depart" className="form-label">
//                                 Departure
